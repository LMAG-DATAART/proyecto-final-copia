...
const Empleos = () => {
  ...
  const allJobs = [
    ...
    {
      title: "Desarrolladora Backend (Java)",
    ...
    {
      title: "Desarrolladora Backend (Node.js)",
      company: "Innovatech",
      country: "United States",
      location: "Seattle, WA",
      date: "2024-10-26",
    ...
    {
      title: "Ingeniera de Software (C#)",
      company: "Financial Services Co.",
      country: "United States",
      location: "Nueva York, NY",
      date: "2024-10-28",
      image: mujerIngeniera,
    },
    {
      title: "Desarrolladora de Aplicaciones Móviles (Android)",
    ...
    },
    {
      ...
      location: "Miami, FL",
      date: "2024-10-30",
      image: mujerAsistente,
    },
    {
      title: "Asistente Virtual Administrativo",
      company: "Virtual Assist Co.",
      country: "United States",
      location: "Chicago, IL",
      date: "2024-10-28",
      image: mujerAsistente,
    ...
    {
      title: "Asistente Virtual de Marketing",
    ...
    {
      title: "Ingeniera de Software (Python)",
    ...
    {
      title: "Desarrolladora de Aplicaciones Móviles (iOS)",
    ...
    {
      title: "Gerente de Proyectos de TI",
      company: "Tech Managers",
      country: "Ireland",
  ...
  const handleSearch = async () => {
    ...
    const filtered = allJobs.filter((job) => {
      ...
      const matchesCountry = selectedCountry
        ? job.country.toLowerCase() === selectedCountry
        : true;
    ...
    if (jobsWithFlags.length === 0) {
      alert(
        "No se encontraron trabajos que coincidan con la palabra clave ingresada."
      );
    }
  };
  ...
  return (
    <div className={styles.container}>
        ...
        <div className={styles.suggestionBox}>
          ...
          <div className={styles.searchOptions}>
            <button
              ...
              onClick={() =>
                handleKeywordChange({
                  target: { value: "Desarrolladora Frontend" },
                })
              }
            >
            ...
            <button
              ...
              onClick={() =>
                handleKeywordChange({
                  target: { value: "Desarrolladora Backend" },
                })
              }
            >
            ...
            <button
              ...
              onClick={() =>
                handleKeywordChange({
                  target: { value: "Ingeniera de Software" },
                })
              }
            >
            ...
            <button
              ...
              onClick={() =>
                handleKeywordChange({
                  target: { value: "Desarrolladora de Aplicaciones Móviles" },
                })
              }
            >
            ...
            <button
              className={styles.searchButton}
              onClick={() =>
                handleKeywordChange({ target: { value: "Asistente Virtual" } })
              }
            >
              Asistente Virtual
            </button>
      ...
      <footer className={styles.foooter}>
        ...
        <p>
          Agradecemos a nuestros patrocinadores por su invaluable apoyo a
          nuestra misión de empoderar a las mujeres en el mundo laboral.
          <br />
          Empresas como Microsoft, Google, Amazon y GitHub se unen a nuestro
          esfuerzo por crear oportunidades de desarrollo
          <br />y crecimiento profesional.
        </p>
      </footer>
    </div>
  );
