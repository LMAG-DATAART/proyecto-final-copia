  ...
  return (
    <div className={styles.contAiner}>
      ...
      <div className={styles.tablacon}>
        <h1 className={styles.tittulo}>
          Hackathon Internacional Femenina: ¡Únete a la Revolución de la
          Programación!
        </h1>
      </div>
      <div className={styles.containerCard}>
        <div className={styles.ProfileCard}>
          ...
          <p className={styles.ProfileDescription}>
            {" "}
            Estados Unidos, 15 de enero de 2025. <br /> <br />
            Se explorarán desafíos como la creación de soluciones innovadoras,
            optimización de algoritmos y desarrollo de aplicaciones
            colaborativas.
          </p>
        ...
        <div className={styles.ProfileCard}>
          ...
          <p className={styles.ProfileDescription}>
            Canadá, 25 de enero del 2025. <br /> <br />
            Se desafiará a los participantes a resolver problemas complejos,
            diseñar sistemas escalables y crear soluciones tecnológicas
            impactantes.
          </p>
          <div className={styles.ProfileButton}>
            <button>Inscribirse</button>
        ...
        <div className={styles.ProfileCard}>
          ...
          <p className={styles.ProfileDescription}>
            Reino Unido, 28 de febrero del 2025. <br /> <br />
            Los participantes tendrán la oportunidad de trabajar en proyectos de
            software, mejorar la experiencia de usuario y construir prototipos
