...
const ConsultarAplicaciones = () => {
  ...
  const data = [
    ...
    { id: 4, 
      ...
      departamento: 'Research and Development',
      ubicacion: 'Mountain View',
      fechaSolicitud: '26-10-2024',
      estado: 'En proceso',
      pais: 'United States',
    },
    { id: 5, 
      ...
      especialidad: 'Ciberseguridad',
      departamento: 'Infraestructura',
      ubicacion: 'Menlo Park',
      fechaSolicitud: '27-10-2024',
      estado: 'Pendiente',
      pais: 'United States',
    },
    { id: 6, 
    ...
    { id: 13, 
      ...
      departamento: 'Consultoría Tecnológica', 
      ubicacion: 'Bangalore', 
      fechaSolicitud: '09-11-2024', 
      estado: 'En proceso', 
      pais: 'India' 
    },
    { id: 14, 
    ...
    { id: 16, 
      empresa: 'Emirates', 
      especialidad: 'Desarrollo de Software', 
      departamento: 'Psicología Organizacional', 
      ubicacion: 'Dubái', 
    ...
    { id: 17, 
      ...
      especialidad: 'Gestión de Talento', 
      departamento: 'Psicología Laboral', 
      ubicacion: 'Doha', 
      fechaSolicitud: '13-11-2024', 
      estado: 'Pendiente', 
      pais: 'Qatar' 
    },
    { id: 18, 
    ...
    <div>
      ...
      <div>
        {aplicaciones.length === 0 ? (
          <p>No hay aplicaciones disponibles para este filtro.</p>
        ) : (
