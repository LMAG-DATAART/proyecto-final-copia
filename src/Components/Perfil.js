...
const Perfil = () => {
  const [userInfo, setUserInfo] = useState({
    ...
    description:
      "Desarrolladora Frontend con 5 años de experiencia en React y diseño de interfaces atractivas.",
    ...
    experience: [
      {
        ...
        description:
          "Encargada del desarrollo de interfaces de usuario para aplicaciones web, usando React y CSS avanzado.",
      },
      {
        ...
        date: "2019 - 2022",
        description:
          "Desarrolladora junior en proyectos de aplicaciones web, asistiendo en el desarrollo y prueba de componentes de React.",
      },
    ],
    education: [
      {
  ...
  const jobNotifications = [
    {
      id: 1,
      message: "Se ha publicado un nuevo trabajo en React en Bogotá.",
      Image: empleoImagen,
    },
    {
      id: 2,
      message: "Oportunidad para Desarrollador Frontend en Cúcuta.",
      Image: empleoImagen2,
    },
    {
      id: 3,
      message: "Curso de JavaScript gratuito disponible en línea.",
      Image: empleoImagen3,
    },
    {
      id: 4,
      message: "Convocatoria abierta para el programa de pasantías.",
      Image: empleoImagen4,
    },
  ];
            ...
            <div className={styles.personalDataSection}>
              ...
              {editingSection === "Datos Personales" ? (
                ...
                <>
                  ...
                  <p>
                    <strong>Ubicación:</strong> {userInfo.location}
                  </p>
                  <p>
                    <strong>Descripción:</strong> {userInfo.description}
                  </p>
                  <button
                    onClick={() => handleEdit("Datos Personales")}
                    className={styles.editButton}
                  >
                    Editar
                  </button>
            ...
            <div className={styles.skillsSection}>
              ...
              {editingSection === "Habilidades" ? (
                ...
                <>
                  ...
                  <button
                    onClick={() => handleEdit("Habilidades")}
                    className={styles.editButton}
                  >
                    Editar
                  </button>
            ...
            {suggestedUsers.map((user) => (
              <li key={user.id} className={styles.suggestedFriend}>
                <img
                  ...
                  alt={`${user.name}`}
                  className={styles.suggestedFriendImage}
                />
                <span>{user.name}</span>
                <button
                  ...
                  onClick={() =>
                    alert(
                      "Su solicitud ha sido enviada, Se le confirmará cuando la acepten. "
                    )
                  }
                >
                  Agregar
          ...
          <div className={styles.jobNotificationsSection}>
            ...
            <ul className={styles.jobNotificationsList}>
              {jobNotifications.map((notification) => (
                <li
                  key={notification.id}
                  className={styles.jobNotificationItem}
                >
                  <img
